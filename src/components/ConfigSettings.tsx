...
export function ConfigSettings({ config, onChange, onImport }: Props) {
  ...
  return (
    <div className="flex items-center gap-4 px-4 py-2 bg-red-50 border-b border-red-200 text-sm flex-wrap">
      ...
      <label className="flex items-center gap-2">
        ...
        <select
          className="border border-gray-300 rounded px-2 py-1 focus:outline-none focus:border-red-400"
      ...
      <label className="flex items-center gap-2">
        ...
        <input
          className="border border-gray-300 rounded px-2 py-1 w-20 focus:outline-none focus:border-red-400"
